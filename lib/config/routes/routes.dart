import 'package:droppy/features/presentation/pages/add_report.dart';
...
import '../../features/presentation/pages/user/user_followers_pending.dart';
            ...
            routes: [
              GoRoute(
                ...
                builder: (context, state) {
                  ...
                  final String? dropId = extras?['dropId'];
                  final String? commentId = extras?['commentId'];
                  final String? commentResponseId = extras?['commentResponseId'];
              ...
              GoRoute(
                ...
                name: 'notification',
                builder: (context, state) {
                  return const UserFollowersPendingView();
                },
              ),
              GoRoute(
                path: 'add-drop',
