...
class AddCommentReportView extends StatefulWidget {
  final String commentId;

  const AddCommentReportView({
    Key? key,
    required this.commentId,
  }) : super(key: key);

  @override
  State<AddCommentReportView> createState() => _AddCommentReportViewState();
}

class _AddCommentReportViewState extends State<AddCommentReportView> {
                          ...
                          leadingOnPressed: () {
                            if(state is! PostReportLoading && formKey.currentState!.validate()) {
                              BlocProvider.of<ReportsBloc>(context).add(
                                PostReport({
                                  'comment': '/comments/${widget.commentId}',
